...
public class Clase
{
	public static void main (String[]args)
	{
		...
		//Voy a fijar una fecha de reparacion a un vehiculo que no existe
		// en el taller, dara error
		taller.reparado(matricula3);
		//Este funcionara bien
		taller.reparado(matricula1);
		//Este dará error, no esta reparado, por lo que no puede salir,
		// es una condicion que hemos puesto en el if
